...
y = expo(np.linspace(0.5, 2.25, 100), params[0], params[1])

plt.plot(np.linspace(0.5, 2.25, 100)+(size/2), y, "r--", linewidth = 2)           #+size/2 weil ich damit die plot kurve in die mitte der bars packe
plt.title('Histogram 24C run length', fontsize = 15)
plt.xlabel('run length [$\mu m$]', fontsize = 13)
plt.ylabel('probability per runlenght [$\mu m ^{-1}$]', fontsize = 13)
plt.legend(['fitted pdf, $\mu$ = ' + str(round(params[0],2)),  "measured distribution"], fontsize = 13)
...
plt.ylabel('cummulative probability per runlength [$\mu m ^{-1}$]', fontsize = 13)
plt.legend(['fitted cdf, $\mu$ = ' + str(round(params[0],2)),  "measured distribution"], fontsize = 13)
plt.title('commulative probability 24C run length', fontsize = 15)
...
plt.title('histogram 24C velocity', fontsize = 15)
plt.xlabel('velocity [$\mu m/s$]', fontsize = 13)
plt.ylabel('probability per velocity [$s/\mu m$]', fontsize = 13)
...
plt.title('histogram 34C runlength', fontsize = 15)
plt.xlabel('run length [$\mu m$]', fontsize = 13)
...
plt.xlabel('runlength [$\mu m$]', fontsize = 13)
plt.ylabel('cummulative probability per runlength [$\mu m ^{-1}$]', fontsize = 13)
plt.title('commulative probability 34C run length', fontsize = 15)
plt.legend(['fitted cdf, $\mu$ = ' + str(round(params[0],2)),  "measured distribution"], fontsize = 13)
...
plt.title('histogram 34C velocity', fontsize = 15)
plt.xlabel('velocity [$\mu m/s$]', fontsize = 13)
