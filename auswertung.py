...
plt.title('Histogram 24C run length')
plt.xlabel('run length [$\mu m$]')
plt.ylabel('probability per runlenght [$\mu m ^{-1}$]')
...
plt.xlabel('runlength [$\mu m$]')
plt.ylabel('cummulative probability per runlength [$\mu m ^{-1}$]')
plt.legend(['fitted cdf, $\mu$ = ' + str(round(params[0],2)),  "measured distribution"], fontsize = 13)
plt.title('commulative probability 24C run length')
...
plt.title('histogram 24C velocity')
plt.xlabel('velocity [$\mu m/s$]')
plt.ylabel('probability [$s/\mu m$]')
...
plt.title('histogram 34C runlength')
plt.xlabel('run length [$\mu m$]')
plt.ylabel('probability [$\mu m^{-1}$]')
plt.legend(['fitted pdf, $\mu$ = ' + str(round(params[0],2)),  "measured distribution"], fontsize = 13)
...
plt.xlabel('runlength [$\mu m$]')
plt.ylabel('cummulative probability per runlength [$\mu m ^{-1}$]')
plt.title('commulative probability 34C run length')
plt.legend(['fitted cdf, $\mu$ = ' + str(round(params[0],2)),  "measured distribution"], fontsize = 13)
...
plt.title('histogram 34C velocity')
plt.xlabel('velocity [$\mu m/s$]')
plt.ylabel('probability [$s/\mu m$]')
